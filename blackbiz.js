...
// Armure de gardetombe de l'adepte
// Armure de judicateur de l'adepte
// Chaussures de mercenaire de l'adepte
// Chaussures de tourmenteur de l'adepte
// Capuche de tourmenteur de l'adepte
// Veste de mercenaire de l'adepte
	function gotgettem(){
	                ...
	                if ( val.UniqueName.indexOf("T2_") >= 0) {
	                    ...
	                    if(val.UniqueName.indexOf("@") >= 0){
	                    	...
	                    	if (val.UniqueName.indexOf("T4_") >= 0) {
	                       		if (val.UniqueName.indexOf(kindTypeAsked) >= 0 ) {
	                              	//var nom_fr = (val.LocalizedNames[2].Value).substring(0,25);
	                              	//var nom_fr = (val.LocalizedNames[2].Value).slice(12);
	                              	var nom_fr = val.LocalizedNames[2].Value.substring(0, val.LocalizedNames[2].Value.length-12);

	                                //optionselectbbiz
	                                $("#resultblackbiz").append("<tr><td>"+nom_fr+"</td><td></td><td></td><td></td><td></td><td></td>");
	                       		} else {
	                       			return null;
	                       		}  
	                    	} else {
