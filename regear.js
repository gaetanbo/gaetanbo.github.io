    ...
    $("#regear_pul_prices").click(function(){
        ...
        switch (gear_set) {
            case 'tank':
                ...
                break;
            case 'fire':
                var gears = ['T6_BAG','T8_HEAD_PLATE_SET2','T4_CAPEITEM_FW_FORTSTERLING','T8_2H_FIRESTAFF_HELL','T8_ARMOR_CLOTH_SET2','T5_MOUNT_ARMORED_HORSE','T8_SHOES_CLOTH_SET1','T8_MEAL_STEW','T4_POTION_COOLDOWN'];
                break;
            case 'heal':
